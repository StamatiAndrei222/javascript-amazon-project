import {cart, calculateCartQuantity, updateQuantity, isValidQuantity, updateDeliveryOption} from '../data/cart.js';
...
cart.forEach((cartItem) => {
  ...
  console.log(cartItem.deliveryOptionId, deliveryOptions);
